...
CREATE TABLE `avaliacao` (
    ...
    INDEX `AVALIACAO_avaliadoId_fkey`(`avaliadoId`),
    INDEX `AVALIACAO_avaliadorId_fkey`(`avaliadorId`),
...
CREATE TABLE `match` (
    ...
    INDEX `MATCH_idinterc_fkey`(`idinterc`),
    INDEX `MATCH_idviajante_fkey`(`idviajante`),
    PRIMARY KEY (`idmatch`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
